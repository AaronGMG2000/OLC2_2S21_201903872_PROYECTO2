...
class Generador(object):
    ...
    def potencia(self):
        ...
        self.place_operation(comp, 0, '','')
        self.place_operation(mult, 1, '','')
        self.place_label(w1)
        self.place_if(comp, pot, '>=', exit)
        self.get_stack(value, pos_value)
        self.place_operation(mult, mult, value, '*')
    ...
    def menor_string(self):
        if "menor_string" in self.native_true:
            return
        self.native_true.append("menor_string")
        self.in_native = True
        self.new_function('menor_string')
        temp = self.new_temporal()
        temp2 = self.new_temporal()
        self.place_operation(temp, 'P', 1, '+')
        self.get_stack(temp2, temp)
    ...
    def mayor_string(self):
        if "mayor_string" in self.native_true:
            return
        self.native_true.append("mayor_string")
        self.in_native = True
        self.new_function('mayor_string')
        temp = self.new_temporal()
        temp2 = self.new_temporal()
        self.place_operation(temp, 'P', 1, '+')
        self.get_stack(temp2, temp)
    ...
    def mayor_igual_string(self):
        if "mayor_igual_string" in self.native_true:
            return
        self.native_true.append("mayor_igual_string")
        self.in_native = True
        self.new_function('mayor_igual_string')
        temp = self.new_temporal()
        temp2 = self.new_temporal()
        self.place_operation(temp, 'P', 1, '+')
        self.get_stack(temp2, temp)
    ...
    def menor_igual_string(self):
        if "menor_igual_string" in self.native_true:
            return
        self.native_true.append("menor_igual_string")
        self.in_native = True
        self.new_function('menor_igual_string')
        temp = self.new_temporal()
        temp2 = self.new_temporal()
        self.place_operation(temp, 'P', 1, '+')
        self.get_stack(temp2, temp)
